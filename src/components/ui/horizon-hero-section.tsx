    ...
    const createStarField = () => {
      ...
      for (let i = 0; i < 3; i++) {
        ...
        for (let j = 0; j < starCount; j++) {
          ...
          // Color variation - brand colors
          const color = new THREE.Color();
          const colorChoice = Math.random();
          if (colorChoice < 0.7) {
            color.setHSL(0, 0, 0.8 + Math.random() * 0.2);
          } else if (colorChoice < 0.9) {
            color.setHSL(0.6, 0.7, 0.7); // Blue tint
          } else {
            color.setHSL(0.85, 0.6, 0.7); // Purple tint
          }
      ...
      const material = new THREE.ShaderMaterial({
        ...
        fragmentShader: `
          ...
          void main() {
            ...
            vec3 atmosphere = vec3(0.4, 0.3, 1.0) * intensity;
  ...
  return (
    <div ref={containerRef} className="hero-container">
      ...
      <div ref={menuRef} className="side-menu" style={{ visibility: 'hidden' }}>
        <div className="vertical-text">SECONDSPACE</div>
      </div>

      {/* Main content - First section */}
      <div className="hero-content">
        <div className="inline-flex items-center px-4 py-2 rounded-full bg-background/20 backdrop-blur-sm border border-primary/30 mb-8 animate-fade-in">
          <span className="text-sm text-foreground/80">🚀 Trusted by <Counter end={50} suffix="+" className="inline" /> Brands</span>
        </div>

        <h1 ref={titleRef} className="hero-title" style={{ visibility: 'hidden' }}>
          <span className="text-gradient">SECONDSPACE</span>
        </h1>
        ...
        {/* CTA Buttons */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8 animate-fade-in" style={{ animationDelay: '1s' }}>
          <Button 
            size="lg" 
          ...
          <Button 
            ...
            className="border-primary/50 bg-background/10 backdrop-blur-sm hover:bg-primary/20 px-8 py-4"
          >
            Book Strategy Call
          </Button>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 animate-fade-in" style={{ animationDelay: '1.2s' }}>
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-foreground/60">Brands Grown</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-gradient mb-2">
              <Counter end={5} suffix="M+" />
            </div>
            <div className="text-sm text-foreground/60">Leads Generated</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-gradient mb-2">
      ...
      <div className="scroll-sections">
        <section className="content-section">
          <h2 className="section-title text-gradient">GROWTH</h2>
          <div className="section-subtitle">
            <p className="subtitle-line">From social media to web development,</p>
            <p className="subtitle-line">we deliver end-to-end digital solutions</p>
          </div>
        </section>
        
        <section className="content-section">
          <h2 className="section-title text-gradient">SUCCESS</h2>
          <div className="section-subtitle">
            <p className="subtitle-line">Engagement, leads, and sales—</p>
            <p className="subtitle-line">driving results that matter globally</p>
          </div>
        </section>
      </div>
    </div>
