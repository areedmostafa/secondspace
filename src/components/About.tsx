...
import { Globe, Layers, BarChart3, Lightbulb, Sparkles, ArrowRight } from 'lucide-react';
              ...
              return (
                ...
                >
                  ...
                  <div className="relative rounded-2xl overflow-hidden h-full">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-primary to-secondary rounded-2xl opacity-0 group-hover:opacity-100 transition-all duration-500 blur-sm" />
                    ...
                    <div className="relative bg-card/40 backdrop-blur-xl border border-border/30 rounded-2xl p-6 m-[1px] h-full transition-all duration-500 group-hover:bg-card/60 group-hover:border-primary/30">
                      ...
                      <div className="absolute top-4 right-4 w-20 h-20 bg-gradient-to-r from-primary/50 to-secondary/50 rounded-full blur-2xl opacity-10 group-hover:opacity-30 transition-opacity duration-500" />
                      
                      {/* Icon */}
                      <div className="relative w-12 h-12 bg-gradient-to-r from-primary to-secondary rounded-xl flex items-center justify-center mb-4 shadow-lg group-hover:scale-110 group-hover:shadow-xl transition-all duration-300">
