            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">secondspaceteam@gmail.com</div>
                </div>
              </div>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-muted rounded-lg flex items-center justify-center mr-4">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">+880 1312-290454</div>
                </div>
              </div>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-muted rounded-lg flex items-center justify-center mr-4">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">Nikunja 2, Dhaka 1229</div>
                </div>
              </div>
            </div>
